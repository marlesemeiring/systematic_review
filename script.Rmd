...
df_a %>% 
  ...
  ggsave("systematic_review/plots/years_1_bar.png", units = "cm", 
...
dplyr::summarise(total_citation = sum(cited)) %>% 
 ...
 theme_bw()+
  ...
  ggsave("systematic_review/plots/authors_cited_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
ggplot() + 
 ...
 theme_bw()+
  ...
  theme(axis.title.x=element_text(size=18,face="bold"),
       ...
       axis.text.y = element_text(size = 14, color = "black"),
       axis.text.x = element_text(size = 14, color = "black"))+
  ggsave("systematic_review/plots/authors_written_bar.png", units = "cm", 
...
df_a %>% 
  ...
  ggsave("systematic_review/plots/source_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
freq %>% 
  ...
  ggsave("systematic_review/plots/freq_auth_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
mapping %>%
  ...
  theme(axis.title.x=element_text(size=14,face="bold"),
       ...
       axis.text.x = element_text(size = 10, color = "black"))+
  coord_flip()+
  ggsave("systematic_review/plots/country_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
ggplot(data = world.df) + 
  ...
  ggsave("systematic_review/plots/map1.png", units = "cm", 
...
manage %>% 
 ggplot() + 
  ...
  theme(axis.title.x=element_text(size=14,face="bold"),
       ...
       axis.text.y = element_text(size = 10, color = "black"),
       axis.text.x = element_text(size = 10, color = "black", angle = 90))+
  ggsave("systematic_review/plots/manage_bar.png", units = "cm", 
...
manage %>% 
 ...
 ggplot() + 
  ...
  theme(axis.title.x=element_text(size=14,face="bold"),
       ...
       axis.text.y = element_text(size = 10, color = "black"),
       axis.text.x = element_text(size = 10, color = "black", angle = 90))+
  ggsave("systematic_review/plots/manage_bar_6.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
read_docx() %>% 
  ...
  print(target = "systematic_review/plots/manageplot_table.docx")
...
crop_df1 <- crop_df %>% 
 ...
 crop_df1 %>% 
  ...
  ggsave("systematic_review/plots/crops_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
crop_df %>% 
  ...
  theme(axis.title.x=element_text(size=14,face="bold"),
       ...
       axis.text.y = element_text(size = 10, color = "black"),
       axis.text.x = element_text(size = 10, color = "black"))+
  ggsave("systematic_review/plots/crops_soja_sun_bar_abs.png", units = "cm", 
            width = 50, height = 30, dpi = 300)
...
crop_df2 %>% 
  ...
  theme(axis.title.x=element_text(size=14,face="bold"),
       ...
       axis.text.y = element_text(size = 10, color = "black"),
       axis.text.x = element_text(size = 10, color = "black"))+
  ggsave("systematic_review/plots/crops_soja_sun_bar_title.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
actives_df %>% 
 ...
 ggplot() + 
  ...
  theme(axis.title.x=element_text(size=14,face="bold"),
       ...
       axis.text.x = element_text(size = 10, color = "black"))+
  coord_flip()+
  ggsave("systematic_review/plots/active_bar.png", units = "cm", 
            width = 30, height =20, dpi = 300)
...
cropactive_df1 %>%
  ...
  theme(axis.title.x=element_text(size=18,face="bold"),
    ...
    coord_flip()+
  ggsave("systematic_review/plots/crop_active_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
enviactive_df1 %>%
  ...
  scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 10))+
   theme(axis.title.x=element_text(size=18,face="bold"),
       ...
       legend.title = element_text(size = 18))+
    coord_flip()+
  ggsave("systematic_review/plots/environment_active_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
bio_agent_df %>% 
 ggplot() + 
  ...
  theme(axis.title.x=element_text(size=18,face="bold"),
       ...
       legend.title = element_text(size = 18))+
  coord_flip()+
  ggsave("systematic_review/plots/agent_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
cropagent_df1 %>%
 ...
 theme(axis.title.x=element_text(size=18,face="bold"),
       ...
       legend.title = element_text(size = 18))+
  coord_flip()+
  ggsave("systematic_review/plots/crop_agent_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
enviagent_df1 %>%
  ...
  theme(axis.title.x=element_text(size=18,face="bold"),
       ...
       legend.title = element_text(size = 18))+
    coord_flip()+
  ggsave("systematic_review/plots/environment_agent_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
common_name_df %>% 
 ...
 ggplot() + 
  ...
  theme(axis.title.x=element_text(size=18,face="bold"),
       ...
       axis.text.x = element_text(size = 14, color = "black"))+
  coord_flip()+
  ggsave("systematic_review/plots/commonname_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
...
interact_df1 %>%
  ...
  scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 10))+
  coord_flip()+
  ggsave("systematic_review/plots/country_host_bar.png", units = "cm", 
            width = 30, height = 20, dpi = 300)
